...
<body>
    <div class="container fluid">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="latitude" value="<?php echo $poi_x; ?>">
          </div>
          <div class="form-group">
        ...
        <a href="profile.php" role="button" class="btn btn-lg btn-primary btn-block mt-2">Cancel</a>
    </div>
